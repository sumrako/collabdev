...
urlpatterns = [
    ...
    path('user-details/<str:username>/', UserDetailsView.as_view()),
    ...
    path('notification/<int:id>/', NotificationUpdateAPIView.as_view(), name='notification_detail'),
